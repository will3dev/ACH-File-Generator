...
class Create_ACH_File:
    ...
    def generate_batch(self, entry_list, originator_info, effective_date: str, batch_num):
        ...
        bh = BatchHeader(
            ...
            entryDate=effective_date.get('effective_date'),
            odfi=originator_info.get('odfi'),
            batch_num=batch_num
        )
        header = bh.line_create() + '\n'

        entries = generate_entries(entry_list, originator_info, bh)
    ...
    def generate_file(self):
        ...
        for batch in self.transaction_listing:
            ...
            transaction = generate_batch(entries, originator, effective_date, str(batch_num))
